  ...
  data: () => ({
    items: [
      ...
      },
      {
        ...
        example:
          "Method definition: @ twinkleTwinkleChorus (), Method Call: twinkleTwinkleChorus ()"
      },
      {
        title: "FREQUENCY",
        type: "Number",
      ...
      },
      {
        ...
        example: 'note 262 "sine" SIXTEENTH'
      },
      {
        title: "EIGHTH",
        type: "Number",
